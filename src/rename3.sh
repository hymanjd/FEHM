# rename GAZ files SRC_W_BUILD_050124/SRC_MASTER
# remove rm write_avs_node_mat.f no longer used
# grep SRC_ *proj | wc
# 660 files in FEHM3.6_VER2.vfproj
# check file names based on subroutine name
 
rm allocmem_2c.f
rm allocmem_2d.f
mv allocmem_2e.f allocmem.f
...
# note module avsio and subroutine avs_io
